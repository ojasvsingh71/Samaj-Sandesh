    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 relative">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <AnimatedCard className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-lg rounded-2xl p-8 mb-8 text-center border border-white/20 dark:border-slate-700/50">
